...
export default function AuthPage({ initialMode = 'signin' }: AuthPageProps) {
    ...
    const leftPanelContent = mode === 'signin' ? {
        title: 'AVAA',
        ...
        subtitle: 'Create an account and explore thousands of job opportunities from top companies.',
        titleClass: 'tracking-wide italic',
    };
        ...
        <div className="flex min-h-screen page-enter">
            ...
            <div className="hidden lg:flex lg:w-[45%] bg-[#f0f2f5] flex-col items-center justify-center px-12 relative">
                ...
                >
                    ...
                    <h1 className={`text-3xl font-bold text-[#1e3a4f] mb-4 ${leftPanelContent.titleClass}`}>
            ...
            {/* ══════════════ RIGHT PANEL ══════════════ */}
            <div className="flex-1 flex items-center justify-center px-6 sm:px-12 lg:px-16 bg-[#f5f7fa] overflow-hidden">
                <div className="w-full max-w-[480px] py-12 relative">
                    {/* Mobile logo */}
                        ...
                        {mode === 'signin' ? (
                            ...
                            <div>
                                ...
                                <form onSubmit={handleSignIn} className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input id="login-email" type="email" placeholder="you@example.com" value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)}
                                                className="w-full pl-12 pr-4 py-3.5 border border-[#d1d5db] rounded-xl text-[15px] text-[#1a1a1a] placeholder-[#9ca3af] bg-white focus:outline-none focus:ring-2 focus:ring-[#3CD894] focus:border-transparent transition-all" required />
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <Link href="/user/forgot-password" className="text-sm font-medium text-[#3CD894] hover:text-[#2bb574] transition-colors">Forgot password?</Link>
                                        </div>
                                        <div className="relative">
                                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                            ...
                                            <input id="login-password" type={loginShowPassword ? 'text' : 'password'} placeholder="••••••••" value={loginPassword} onChange={(e) => setLoginPassword(e.target.value)}
                                                className="w-full pl-12 pr-12 py-3.5 border border-[#d1d5db] rounded-xl text-[15px] text-[#1a1a1a] placeholder-[#9ca3af] bg-white focus:outline-none focus:ring-2 focus:ring-[#3CD894] focus:border-transparent transition-all" required />
                                ...
                                <p className="text-center text-[15px] text-[#6b7280] mt-8">
                                    ...
                                    <button onClick={() => switchMode('signup')} className="font-semibold text-[#3CD894] hover:text-[#2bb574] transition-colors">
                                        Sign up
                                    </button>
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-center text-[15px] text-[#6b7280] mt-8">
                                    ...
                                    <button onClick={() => switchMode('signin')} className="font-semibold text-[#3CD894] hover:text-[#2bb574] transition-colors">
                                        Sign in
                                    </button>
                                </p>
                            </div>
